...
{
    public partial class frmOrigenes : Form
    {
        ...
        private void Habilitar()
        {
            ...
            this.TBOrigen.ReadOnly = false;
            this.TBOrigen.BackColor = Color.FromArgb(3, 155, 229);
            this.TBOrigen.ForeColor = Color.FromArgb(255, 255, 255);
            this.TBOrigen.Text = Campo;
        ...
        private void Guardar_SQL()
        {
            try
            {
                ...
                else
                {
                    ...
                    if (this.Digitar)
                    {
                        rptaDatosBasicos = fOrigen.Guardar_DatosBasicos
                            ...
                            (
                                 ...
                                 //Panel Datos Basicos
                                 this.TBOrigen.Text, this.TBDescripcion.Text, this.TBObservacion.Text,
                    ...
                    {
                        rptaDatosBasicos = fOrigen.Editar_DatosBasicos
        ...
        private void TBBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (Consultar == "1")
                {
                    if (TBBuscar.Text != "")
                    {
                        this.DGResultados.DataSource = fOrigen.Buscar(this.TBBuscar.Text, 1);
        ...
        private void TBOrigen_Enter(object sender, EventArgs e)
        {
            ...
            if (TBOrigen.Text == Campo)
            {
                this.TBOrigen.BackColor = Color.Azure;
                this.TBOrigen.ForeColor = Color.FromArgb(0, 0, 0);
                this.TBOrigen.Clear();
            }
            else
            {
        ...
        private void TBOrigen_Leave(object sender, EventArgs e)
        {
            ...
            {
                TBOrigen.BackColor = Color.FromArgb(3, 155, 229);
            }
        }
