    ...
    public class Conexion_Origen
    {
        public DataTable Lista()
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("Consulta.Origen", SqlCon);
        ...
        public string Guardar_DatosBasicos(Entidad_Origen Obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon = Conexion_SQLServer.getInstancia().Conexion();
                SqlCommand Comando = new SqlCommand("Sistema.LI_Origen", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public string Editar_DatosBasicos(Entidad_Origen Obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                //Panel Datos Basicos
                Comando.Parameters.Add("@Idorigen", SqlDbType.Int).Value = Obj.Idorigen;
                Comando.Parameters.Add("@Origen", SqlDbType.VarChar).Value = Obj.Origen;
                Comando.Parameters.Add("@Descripcion", SqlDbType.VarChar).Value = Obj.Descripcion;
                Comando.Parameters.Add("@Observacion", SqlDbType.VarChar).Value = Obj.Observacion;
                Comando.Parameters.Add("@Estado", SqlDbType.Int).Value = Obj.Estado;
        ...
        public string Eliminar(int IDEliminar_Sql, int Auto)
        {
            ...
            try
            {
                ...
                //Panel Datos Basicos
                Comando.Parameters.Add("@Auto", SqlDbType.Int).Value = Auto;
                Comando.Parameters.Add("@Idorigen", SqlDbType.Int).Value = IDEliminar_Sql;
